    ...
    for jdx in range(10):
        ...
        if AUGMENT:
            ...
            for cl in ['tbh_800_new','bkg_all']:
                ...
                if cl == 'tbh_800_new':
                    df_generated = pd.read_csv(f'{PATH_GEN_MODEL}generated_df_{cl}_pres_strict_E10000_S{events_sig}_std.csv')
                else:
                    df_generated = pd.read_csv(f'{PATH_GEN_MODEL}generated_df_{cl}_pres_strict_E10000_S{events_bkg}_std.csv')   
            ...
            # wasserstein_dist(df_test[df_test['y'] == 0], df_augment_train[df_augment_train['y'] == 0], features_used, cls='SIG')
            # wasserstein_dist(df_test[df_test['y'] == 1], df_augment_train[df_augment_train['y'] == 1], features_used, cls='BKG')
